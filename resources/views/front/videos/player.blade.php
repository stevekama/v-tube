...
<body>
    <div class="embed-responsive embed-responsive-16by9" style="background-color: black;">
        <div id="player-wrapper" class="embed-responsive-item">
            <video id="video_1" class="video-js vjs-big-play-centered" style="height: 100%;width: 100%" controls
                preload="auto" poster="{{ $video->thumb }}" data-setup='{"playbackRates": [1, 1.5, 2],
