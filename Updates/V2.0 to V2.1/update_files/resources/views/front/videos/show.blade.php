...
@endphp
  ...
  <div class="container">
      ...
      <div class="col-lg-12"> 
          ...
          <div class="col-lg-9">
            ...
            <!--Second row-->
            <div class="row">
          <div class="col-lg-9"> @if($video->type == 1)
              ...
              <iframe src="{{url('watch/'.$video->id.'/'.$video->slug)}}" allowfullscreen scrolling="no" frameBorder="0" height="100%"></iframe>
                ...
                <h4 class="pull-left" style="cursor: pointer;" data-toggle="modal" data-target="#shareModal"><i class="fa fa-share"></i>&nbsp; Share&nbsp;</h4>
                @if($video->type == 1 && config('app.video_download') == 1)<a class="text-success" href="{{url($video->content)}}" download><h4 class="pull-left" style="cursor: pointer;"><i class="fa fa-download"></i>&nbsp; Download&nbsp;</h4></a>@endif
  ...
  <div class="modal-dialog modal-sm" role="document"> 
      ...
      <!--Body-->
      <div class="modal-body text-center"> <a href="#" onclick="MyWindow=window.open('https://www.facebook.com/dialog/share?app_id=1932129293685911&amp;display=popup&amp;href={{$page_url}}','Facebook share','width=600,height=300'); return false;" class="btn btn-fb btn-sm waves-effect waves-light"><i class="fa fa-facebook"></i></a> <a href="#" onclick="MyWindow=window.open('https://twitter.com/share?url={{$page_url}}','Twitt this','width=600,height=300'); return false;" class="btn btn-tw btn-sm waves-effect waves-light"><i class="fa fa-twitter"></i></a> <a href="#" onclick="MyWindow=window.open('https://plus.google.com/share?url={{$page_url}}','Google Plus share','width=600,height=300'); return false;" class="btn btn-gplus btn-sm waves-effect waves-light"><i class="fa fa-google-plus"></i></a> </div>
      <!--Footer-->
